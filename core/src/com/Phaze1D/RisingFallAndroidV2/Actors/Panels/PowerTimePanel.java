...
public class PowerTimePanel extends Panel {
    ...
    public void createPanelWithTimer(){
        ...
        timeLeftLabel = new Label(timeString, new Label.LabelStyle(BitmapFontSizer.getFontWithSize((int)BitmapFontSizer.sharedInstance().fontPowerTime(), null), Color.BLACK));
    ...
    public void createPanelWithBalls(){
        ...
        ballsLeft = 10;
        ballsLeftLabel = new Label(ballsLeft + "", new Label.LabelStyle(BitmapFontSizer.getFontWithSize((int)BitmapFontSizer.sharedInstance().fontPowerTime(), null), Color.BLACK));
