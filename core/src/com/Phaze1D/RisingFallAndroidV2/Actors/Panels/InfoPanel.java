...
public class InfoPanel extends Panel {
    ...
    public void createPanel(int levelID, int passedScore){
        ...
        Label levelLabel = new Label("  " + levelID, new Label.LabelStyle(BitmapFontSizer.getFontWithSize(0), Color.BLACK));
        levelLabel.setPosition((int)(getWidth()/2 - levelLabel.getWidth()/2), (int)(getHeight()*3/4f - levelLabel.getHeight()/2));
        levelLabel.setAlignment(Align.center);
        addActor(levelLabel);

        Label levelTitle = new Label("LabelK", new Label.LabelStyle(BitmapFontSizer.getFontWithSize(0), Color.BLACK));
        ...
        Label highTitle = new Label("Highk", new Label.LabelStyle(BitmapFontSizer.getFontWithSize(0), Color.BLACK));
        ...
        Label scoreTitle = new Label("ScoreK", new Label.LabelStyle(BitmapFontSizer.getFontWithSize(0), Color.BLACK));
        ...
        Label highScore = new Label("  " + passedScore, new Label.LabelStyle(BitmapFontSizer.getFontWithSize(0), Color.BLACK));
