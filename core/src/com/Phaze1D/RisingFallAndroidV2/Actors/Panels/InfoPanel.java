...
public class InfoPanel extends Panel {
    ...
    public void createPanel(int levelID, int passedScore){
        ...
        Label levelLabel = new Label("  " + levelID, new Label.LabelStyle(BitmapFontSizer.getFontWithSize((int)BitmapFontSizer.sharedInstance().fontGameplayLevelID(), null), new Color(.969f, .576f, .118f, 1)));
